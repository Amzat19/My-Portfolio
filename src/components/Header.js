    ...
    <div className={navState ? 'bg-[rgba(0,0,0,0.8)] w-[100vw] h-[100vh] top-0 left-0 fixed' : 'left-[100%] hidden'}>
      <nav className="w-[50vw] h-[100vh] bg-white relative dark:bg-slate-900">
        ...
        <ul className="pl-4 pt-4 font-medium">
          ...
          <li className="w-[70px] mb-3 lightmodeborder dark:darkmodeborder"><a rel="noreferrer" target="_blank" href="https://drive.google.com/file/d/1Dw9nlfCPhiHH8teKKP3ZaSLwf1U-rRtt/view?usp=sharing">Resume</a></li>
    ...
    <>
      <header className='w-[80vw] mx-auto mb-6 h-20 dark:text-white'>
        <nav className='flex w-[80vw] justify-between h-full'>
          <div className="w-32">
            <span className="bg-gradient-to-r from-[#9845E8] via-[#33D2FF] to-[#DD5789] bg-clip-text text-transparent px-2 text-7xl font-Bangers">AS</span>
          </div>
          <div className="flex align-center">
            ...
            <ul className='md:flex gap-4 pt-6 font-medium hidden '>
              ...
              <li className="lightmodeborder dark:darkmodeborder hover:cursor-pointer" ><a rel="noreferrer" target="_blank" href="https://drive.google.com/file/d/1Dw9nlfCPhiHH8teKKP3ZaSLwf1U-rRtt/view?usp=sharing">Resume</a></li>
