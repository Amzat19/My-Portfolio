...
const AboutMe = ({ theme }) => {
    return (
        <article id="contact" className="mx-auto pb-6 bg-[#FFFFFF] dark:bg-slate-800 rounded-xl shadow-lg md:flex md:justify-between w-[80vw] md:h-[311px] dark:text-[#FFFFFF]">
        ...
        <div className="h-4/5 w-3/5 mx-8 mt-8 lg:w-4/5">
          ...
          <div className="my-6 w-[50vw]">
            ...
            I'm a Software/Frontend developer based in Lagos, Nigeria. I enjoy creating things that live on the internet.
            </p>
          </div>
